...
import com.exoteric.sharedactor.interactors.flowers.UsrChatMsgCacheFlower
...
class RestoreClockUsrChatMessages(private val snftrDatabase: SnftrDatabase) : UsrChatMsgCacheFlower {
    @Throws(Exception::class)
    override fun fetchCachedUsrChatMessages(userUid: String,
                                              channelUid: String):
